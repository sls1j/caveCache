	...
	execCommand: function(n, cmd, value) {
		...
		switch (cmd) {
			...
			case "InsertImage":
				...
				if (this.config[n].ImagePopupExtraUrlParameters === undefined) {
					window.open(imagePopupFile + '?wysiwyg=' + n, 'popup',
						'location=0,status=0,scrollbars=0,resizable=0,width=' + imagePopupWidth + ',height=' + imagePopupHeight + ',top=' + popupPosition.top + ',left=' + popupPosition.left).focus();
				}
				else {					
					window.open(imagePopupFile + '?wysiwyg=' + n + '&' + this.config[n].ImagePopupExtraUrlParameters, 'popup',
						'location=0,status=0,scrollbars=0,resizable=0,width=' + imagePopupWidth + ',height=' + imagePopupHeight + ',top=' + popupPosition.top + ',left=' + popupPosition.left
						).focus();
				}
				break;
